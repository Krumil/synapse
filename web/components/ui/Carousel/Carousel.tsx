...
export interface CarouselProps {
    ...
    loop?: boolean;
    round?: boolean;
    renderCustomContent?: (item: CarouselItem, index: number) => JSX.Element;
}
...
export default function Carousel({
    ...
    return (
        <div
            ref={containerRef}
            className={`relative overflow-hidden  ${round ? "rounded-full" : "rounded-[24px]"}`}
            style={{
                width: `${baseWidth}px`,
                    ...
                    return (
                        <motion.div
                            ...
                            className={`relative shrink-0 flex flex-col ${
                                round
                                    ? "items-center justify-center text-center bg-transparent"
                                    : "items-start justify-between bg-transparent rounded-[12px]"
                            ...
                            {renderCustomContent ? (
                                ...
                                <>
                                    <div className={`${round ? "p-0 m-0" : "mb-4 p-5"}`}>
                                        <span className="flex h-[28px] w-[28px] items-center justify-center rounded-full bg-transparent">
                                            {item.icon}
                                        </span>
                                    </div>
                                    <div className="p-5">
